...
kubectl apply -f https://raw.githubusercontent.com/digitalocean/marketplace-kubernetes/master/stacks/sharkahack-prometheus-operator/yaml/prometheus-operator.yaml
