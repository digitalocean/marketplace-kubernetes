...
- Otomi is installed with a auto generated CA and uses the public IP of the load balancer with nip.io for all hostnames. See the Otomi [documentaion](https://otomi.io/docs/installation/optional) for advanced setup with DNS, value encryption, Let's Encrypt and Azure Active Directory as IdP.
