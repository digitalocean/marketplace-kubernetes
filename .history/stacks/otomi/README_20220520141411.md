...
Otomi offers a complete suite of pre-configured, integrated and automated applications for Kubernetes (like Istio, Kantive, Harbor, Prometheus), combined with developer self-service, as a single installable package.
