...
Otomi offers a complete suite open source applications for Kubernetes, pre-configured, integrated and automated, combined with developer self-service, as a single installable package 
